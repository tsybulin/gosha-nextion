...
// JSON Switch
Entity::Entity(const uint8 id, const char *stateTopic, const char *stateValueTemplate, const char *commandTopic, entity_parser_t parser)
: id(id)
{
...
// Switch
Entity::Entity(const uint8 id, const char *stateTopic, const char *commandTopic, entity_parser_t parser) 
: Entity(id, stateTopic, NULL, commandTopic, parser) 
{
}

// Light
Entity::Entity(const uint8 id,
...
// Sensor
Entity::Entity(const uint8 id, const char *stateTopic, entity_parser_t parser, const char *valueTemplate)
